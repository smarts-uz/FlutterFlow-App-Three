...
import 'scroll_to_page_model.dart';
export 'scroll_to_page_model.dart';

class ScrollToPageWidget extends StatefulWidget {
  const ScrollToPageWidget({Key? key}) : super(key: key);

  @override
  _ScrollToPageWidgetState createState() => _ScrollToPageWidgetState();
}

class _ScrollToPageWidgetState extends State<ScrollToPageWidget> {
  late ScrollToPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ScrollToPageModel());
  }
